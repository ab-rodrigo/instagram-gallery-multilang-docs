...
<p><img src="images/example.png" alt="Overview" title="Overview" style="display: block;margin-left: auto;margin-right: auto;"></p>
...
# Prerequisite
+ Opencart 3.x or 4.x with SSL certificate (**SSL certificate is required for API integration**.).
+ Download the extension in the version corresponding to your Opencart installation.
