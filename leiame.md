...
# Pré-requisitos
+ Opencart 3.x ou 4.x instalado com certificado SSL (**o certificado SSL é necessário para a integração da API**).
+ Download da extensão na versão correspondente a sua intalação Opencart.
